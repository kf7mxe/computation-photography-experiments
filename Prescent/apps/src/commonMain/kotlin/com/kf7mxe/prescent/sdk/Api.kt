...
interface Api {
	...
	val appRelease: com.lightningkite.lightningserver.typed.ClientModelRestEndpoints<com.kf7mxe.prescent.AppRelease, com.kf7mxe.prescent.AppRelease.ID>

	val user: com.lightningkite.lightningserver.typed.ClientModelRestEndpointsAndUpdatesWebsocket<com.kf7mxe.prescent.User, com.kf7mxe.prescent.User.ID>

	interface UserAuthApi : com.lightningkite.lightningserver.sessions.proofs.AuthClientEndpoints<com.kf7mxe.prescent.User, com.kf7mxe.prescent.User.ID>, com.lightningkite.lightningserver.typed.ClientModelRestEndpoints<com.lightningkite.lightningserver.sessions.Session<com.kf7mxe.prescent.User, com.kf7mxe.prescent.User.ID>, kotlin.uuid.Uuid> {
	...
	interface FcmTokenApi : com.lightningkite.lightningserver.typed.ClientModelRestEndpoints<com.kf7mxe.prescent.FcmToken, com.kf7mxe.prescent.FcmToken.ID> {
		/**
		 * Register Token
		 * 
		 * **Auth Requirements:** User with root access
		 * */
		suspend fun registerToken(input: com.kf7mxe.prescent.FcmToken.ID): com.lightningkite.services.database.EntryChange<com.kf7mxe.prescent.FcmToken>
		/**
		 * Test In-App Notifications
		 * 
		 * **Auth Requirements:** User with root access
		 * */
		suspend fun testInAppNotifications(id: com.kf7mxe.prescent.FcmToken.ID): kotlin.String
		/**
		 * Clear Token
		 * 
		 * **Auth Requirements:** No Requirements
		 * */
		suspend fun clearToken(id: com.kf7mxe.prescent.FcmToken.ID): kotlin.Boolean
	}
	val fcmToken: FcmTokenApi

	val organization: com.lightningkite.lightningserver.typed.ClientModelRestEndpoints<com.kf7mxe.prescent.Organization, com.kf7mxe.prescent.Organization.ID>

	val membership: com.lightningkite.lightningserver.typed.ClientModelRestEndpoints<com.kf7mxe.prescent.Membership, com.kf7mxe.prescent.Membership.ID>
