...
class LiveApi(val fetcher: Fetcher) : Api {
	...
	override val appRelease = com.lightningkite.lightningserver.typed.LiveClientModelRestEndpoints(fetcher, "app-releases", com.kf7mxe.prescent.AppRelease.serializer(), com.kf7mxe.prescent.AppRelease.ID.serializer())

	override val user = com.lightningkite.lightningserver.typed.LiveClientModelRestEndpointsAndUpdatesWebsocket(fetcher, "users/rest", com.kf7mxe.prescent.User.serializer(), com.kf7mxe.prescent.User.ID.serializer())

	inner class LiveUserAuthApi : Api.UserAuthApi, com.lightningkite.lightningserver.sessions.proofs.AuthClientEndpoints<com.kf7mxe.prescent.User, com.kf7mxe.prescent.User.ID> by com.lightningkite.lightningserver.sessions.proofs.LiveAuthClientEndpoints(fetcher, "auth/session", com.kf7mxe.prescent.User.serializer(), com.kf7mxe.prescent.User.ID.serializer()), com.lightningkite.lightningserver.typed.ClientModelRestEndpoints<com.lightningkite.lightningserver.sessions.Session<com.kf7mxe.prescent.User, com.kf7mxe.prescent.User.ID>, kotlin.uuid.Uuid> by com.lightningkite.lightningserver.typed.LiveClientModelRestEndpoints(fetcher, "auth/session/sessions", com.lightningkite.lightningserver.sessions.Session.serializer(com.kf7mxe.prescent.User.serializer(), com.kf7mxe.prescent.User.ID.serializer()), kotlin.uuid.Uuid.serializer()) {
	...
	inner class LiveFcmTokenApi : Api.FcmTokenApi, com.lightningkite.lightningserver.typed.ClientModelRestEndpoints<com.kf7mxe.prescent.FcmToken, com.kf7mxe.prescent.FcmToken.ID> by com.lightningkite.lightningserver.typed.LiveClientModelRestEndpoints(fetcher, "fcmTokens", com.kf7mxe.prescent.FcmToken.serializer(), com.kf7mxe.prescent.FcmToken.ID.serializer()) {
		override suspend fun registerToken(input: com.kf7mxe.prescent.FcmToken.ID): com.lightningkite.services.database.EntryChange<com.kf7mxe.prescent.FcmToken> =
			fetcher("fcmTokens/register", HttpMethod.POST, com.kf7mxe.prescent.FcmToken.ID.serializer(), input, com.lightningkite.services.database.EntryChange.serializer(com.kf7mxe.prescent.FcmToken.serializer()))
		override suspend fun testInAppNotifications(id: com.kf7mxe.prescent.FcmToken.ID): kotlin.String =
			fetcher("fcmTokens/${fetcher.url(id, com.kf7mxe.prescent.FcmToken.ID.serializer())}/test", HttpMethod.POST, kotlin.Unit.serializer(), kotlin.Unit, kotlin.String.serializer())
		override suspend fun clearToken(id: com.kf7mxe.prescent.FcmToken.ID): kotlin.Boolean =
			fetcher("fcmTokens/${fetcher.url(id, com.kf7mxe.prescent.FcmToken.ID.serializer())}/clear", HttpMethod.POST, kotlin.Unit.serializer(), kotlin.Unit, kotlin.Boolean.serializer())
	}
	override val fcmToken = LiveFcmTokenApi()

	override val organization = com.lightningkite.lightningserver.typed.LiveClientModelRestEndpoints(fetcher, "organizations", com.kf7mxe.prescent.Organization.serializer(), com.kf7mxe.prescent.Organization.ID.serializer())

	override val membership = com.lightningkite.lightningserver.typed.LiveClientModelRestEndpoints(fetcher, "memberships", com.kf7mxe.prescent.Membership.serializer(), com.kf7mxe.prescent.Membership.ID.serializer())
