...
- [ ] Update the Firebase project info (`apps/google-services.json`, `apps/ios/app/GoogleService-Info.plist`, and `apps/src/jsMain/kotlin/com.kf7mxe.prescent/utils/fcmSetup.js.kt`)
